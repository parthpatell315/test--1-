...
export function RestaurantsModuleView({
  ...
  const restaurants = vendors.filter((v) =>
    ["RESTAURANT", "FOOD", "MEALS"].includes((v.type || "").toUpperCase()),
  );
  ...
  return (
    <div className="space-y-4">
      <VendorSearchToolbar
        ...
        placeholder="Search restaurant, food partner, or city"
      ...
      <div className="overflow-hidden rounded-xl border border-[#E8EEF4] bg-white">
        <table className="w-full border-collapse text-left text-xs">
          <thead className="border-b border-[#E8EEF4] bg-[#F8FAFC] text-[11px] font-semibold text-slate-500">
            <tr>
              <th className="py-3 px-4">Restaurant / Food Partner</th>
                ...
                <td colSpan={5} className="p-12 text-center bg-slate-50/50">
                  <div className="space-y-2 max-w-sm mx-auto">
                    ...
                    <p className="text-sm font-bold text-slate-800">
                      No Restaurant Vendors Found
                    </p>
                    <p className="text-xs text-slate-500">
                      There are no dining partners registered in this scope. Click below to add a restaurant vendor.
                    </p>
                    <Button
                      onClick={onAddVendor}
